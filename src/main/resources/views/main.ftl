        ...
        <div class="layui-side-scroll layui-left-menu">
            <ul class="layui-nav layui-nav-tree layui-left-nav-tree layui-this" id="currency">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-1" data-tab="com/toComPage" target="_self"><i class="fa fa-tty"></i><span class="layui-left-nav"> 商品信息</span></a>
                        </dd>
                    </dl>
                </li>
                </#if>
                ...
                <li class="layui-nav-item">
                    <a href="javascript:;" class="layui-menu-tips"><i class="fa fa-flag"></i><span class="layui-left-nav"> 订单管理</span> <span class="layui-nav-more"></span></a><dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-4" data-tab="order/index" target="_self"><i class="fa fa-user-times"></i><span class="layui-left-nav"> 全部订单</span></a>
                        </dd>
                    </dl>
                </li>
                </#if>
                ...
                <span class="layui-nav-bar" style="top: 201px; height: 0px; opacity: 0;">
