    ...
    <body class="childrenBody">
        <form class="layui-form" style="width:80%;">
            ...
            <div class="layui-form-item layui-row layui-col-xs12">
                ...
                <div class="layui-input-block">
                    <input type="text" class="layui-input verCode"
                           lay-verify="code" name="code" value="${(user.email)!}"
                           id="code"
                           placeholder="请输入验证码">
                    <button id="sendEmailBtn" class="layui-btn layui-btn-warm" >点击我发送验证码</button>
                </div>
